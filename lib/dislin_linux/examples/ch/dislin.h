...
int   gethgt (void);
int   gethnm (void);
void  getico (double x, double y, double *xp, double *yp);
...
void  grafr  (const double *xray, int n, const double *yray, int m);
...
void  itmncat (char *clis, int nmx, const char *cstr);
...
void  legtbl (int i, const char *copt);
...
void  pos3pt (double x, double y, double z, 
              double *xp, double *yp, double *zp);
void  posbar (const char *copt);
int   posifl (int nu, int nbyte); 
void  proj3d (const char *cproj);
...
void  revscr (void);
void  rgbhsv (double xr, double xg, double xb, 
              double *xh, double *xs, double *xv);
...
void  zbffin (void);
int   zbfini (void);
void  zbflin (double x1, double y1, double z1, 
              double x2, double y2, double z2);
