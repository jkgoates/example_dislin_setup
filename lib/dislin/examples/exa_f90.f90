      ...
      '   = EMF     A Windows Enhanced Metafile will be created. ', &
      ...
      INTERFACE 
        ...
        SUBROUTINE EX12_1()
        END SUBROUTINE EX12_1
        SUBROUTINE EX12_2()
        END SUBROUTINE EX12_2
        SUBROUTINE EXA_12()
      ...
      CHARACTER (LEN = 6), DIMENSION (6) :: &
              CPOL = (/'SPLINE','STEM  ','BARS  ','STAIRS', 'STEP  ', & 
                     'LINEAR'/)
...
!     Shading in the XZ plane
      ...
      CHARACTER (LEN=100) :: CT1 = &
      '{M2}C{M4}(x) = {M3P}v{M4}e{E}-t{R}t{E}x-1{R}dt{GDH0.4F-1}0{U1.4M3F3}l'
      CHARACTER (LEN=100) :: CT2 = 'lim{GDHC}x{M3CD1.1}a{C}l{RM}' // &
           ' (1 + {PUH} 1 {RVGD0.5H} x {R}){U1.2H}x{R} = e'
      CHARACTER (LEN=100) :: CT0 = 'Character{H0.5} height{RZ-30}' // &
           '  incli{Z30}nation {ZW0.5}  ratio {WK} fixed width'
      CHARACTER (LEN=60) :: CT3 = &
                     'Underscoring{L}    {P}twice{J}    vectors {PA8V}'
      INTEGER :: NL,NY=1100
